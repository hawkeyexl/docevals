...
**Scope:** consolidating existing deterministic tooling behind docevals, and reaching for the native
...
**Narrative.** This journey carries the product's central design claim: **docevals orchestrates, it
does not reimplement.** A reader who expects docevals to replace Vale has misunderstood the tool and
...
docevals means "a model grades my docs."
